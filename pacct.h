...
static struct {
	...
	// tracked_events autogenerated by convertModel.py
	{
		...
		.event_code = 0x13,
		.umask = 0x0e,
		.coeff = SCALE_COUNTER(61.906900031934676),
	},
	{
		// Page walks completed due to a demand data store to a 4K page.
		.event_code = 0x13,
		.umask = 0x02,
		.coeff = SCALE_COUNTER(-84.08481917781894),
	},
	{
		// Thread cycles when thread is not in halt state
		.event_code = 0x3c,
		.umask = 0x00,
		.coeff = SCALE_COUNTER(0.002362736640414198),
	},
	{
		// Non-modified cache lines that are silently dropped by L2 cache.
		.event_code = 0x26,
		.umask = 0x01,
		.coeff = SCALE_COUNTER(-0.06036205840509001),
	},
	{
		// Demand Data Read requests sent to uncore
		.event_code = 0x21,
		.umask = 0x01,
		.coeff = SCALE_COUNTER(0.9017192847060959),
	},
	{
		// Cycles while L2 cache miss demand load is outstanding.
		.event_code = 0xa3,
		.umask = 0x01,
		.coeff = SCALE_COUNTER(-0.012669363030198832),
	},
	{
		// Number of instructions retired. General Counter - architectural event
		.event_code = 0xc0,
		.umask = 0x00,
		.coeff = SCALE_COUNTER(0.00035986949171729066),
	},
	{
		// Retired uops except the last uop of each instruction.
		.event_code = 0xc2,
		.umask = 0x01,
		.coeff = SCALE_COUNTER(0.0011142775203412114),
	},
};
